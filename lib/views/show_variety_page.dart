...
class ShowVarietyPageState extends State<ShowVarietyPage>
                  ...
                  child: NotificationListener(
                      ...
                      child: CustomScrollView(
                          physics: isFocus
                              ...
                              : new ClampingScrollPhysics(), // 禁用滑动
                          slivers: <Widget>[
                            SliverToBoxAdapter(
                              child: Column(
                                children: <Widget>[
                                                  ...
                                                  Text(
                                                      ...
                                                      style: TextStyle(
                                                          ...
                                                          fontWeight:
                                                              FontWeight.w500)),
                                                  Text(
                                                      "${varietyMsg['priceUpdown1'].toStringAsFixed(2)}  ${varietyMsg['changeRate'].toStringAsFixed(2)}%",
                                                      textAlign:
                                                          TextAlign.center,
                                                      style: TextStyle(
                                                          fontSize: 13.0,
